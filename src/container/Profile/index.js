...
import { ProConst, ProfileData } from "./constant";
class Profile extends Component {
  constructor() {
    super();
    this.state = { remember: false, check: [3] };
  }
  checkClick = (e) => {
    try {
      ...
      <ProfileStyle>
        ...
        <Row gutter={24} className="rowDiv">
          ...
          <Col xs={24} sm={24} md={16} lg={16} xl={20} className="antDiv">
            ...
            <div className="pDiv">
              <h2 className="header">{ProConst.role}</h2>
            ...
            <div className="pDiv">
              <h2 className="header">{ProConst.apr}</h2>
              <Table data={ProfileData} type="profile" />
              <div className="btn">
                <Button>Save</Button>
              </div>
            </div>
